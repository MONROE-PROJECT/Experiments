...
def create_arguments(parser):
    ...
    parser.add_argument('-m', '--MPD',  
                        default = MPD, # AEL -- added a default value for the MPD, also for the number of segments                
    ...
    parser.add_argument('-d', '--DOWNLOAD', action='store_true', # AEL -- as long as we have the logs and the timestamps, we don't need to keep the video segments
                        default=False,
